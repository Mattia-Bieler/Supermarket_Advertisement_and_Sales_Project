...
# Recommendations
2Market should maintain its advertising campaigns across all three social media platforms, with a focus on prioritising Instagram and Twitter over Facebook due to their generally higher effectiveness. Additionally, a thorough examination should be conducted to assess the impact of bulk mail and brochure advertisements. Concerning customer purchasing behavior, further investigation into whether customers prefer online or in-store shopping, as well as the frequency of utilising both options, would provide 2Market with valuable information that could help with targeted advertisements. 
